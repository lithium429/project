...
; (function ($) {
    ...
    */
    $.fn.addOption = function () {
        var add = function (el, v, t, sO, index) {
            ...
            option.title = t;
            option.value = v;
            if(!util.isNull(selectNumber)){
            	option.text = t.length > selectNumber ? util.substring(t, selectNumber) : t;
            }
            else{
            	option.text = t;
            }
		...
		function () {
		    ...
		    if (m) {
		        for (var item in items) {
		            add(this, item.split('|')[0], items[item], sO, startindex);
		            startindex += 1;
		        }
		    }
		    else {
    ...
    *
    */
    $.fn.ajaxAddOption = function (url, params, select,isAsync, fn, args) {
        if (typeof (url) != "string") return this;
        if (typeof (params) != "object") params = {};
        if (typeof (select) != "boolean") select = true;
    	if(typeof(isAsync) != "boolean") isAsync = true;
