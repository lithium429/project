...
<gd:Layout>
	<gd:Navgation addShow="${gdf:judgeRoleMenu(roleMenuList,'添加') }" addlink="" addr="系统日志  &gt; 登录日志"></gd:Navgation>
	<div class="data_model">
	    <table class="wc100">
	        <tr>
	             <td>
					<div class="data_cont_wrap">
						<form id="spec_form" action="admin/loginLog/datalist.do"
										...
										<tr>
											...
											<td>
												<span class="btn btn_pub">
													...
													<a href="admin/loginLog/list.do?menu_id=${menu_id}">重置</a>
												</span>
											</td>
										</tr>
									 </tbody>
